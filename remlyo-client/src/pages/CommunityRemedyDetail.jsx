              ...
              <div className="mb-6">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src =
                      "https://via.placeholder.com/800x400?text=Remedy+Image";
                  }}
                />
              </div>
            ...
            <div className="p-6">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">○</span>
                  <span className="text-gray-700">
                    Online sources suggest turmeric tea has anti-inflammatory
                    properties.
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">○</span>
                  <span className="text-gray-700">
                    The active component curcumin may help reduce
                    migraine-related inflammation.
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">○</span>
                  <span className="text-gray-700">
                    AI Insight: Based on your profile, adding black pepper may
                    increase absorption of beneficial compounds.
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">○</span>
                  <span className="text-gray-700">
                    Bonus Tip: Many users report best results when drinking
                    consistently for at least 2 weeks.
                  </span>
                </li>
              </ul>
            </div>
